...
const faqs = [
  ...
  },
  {
    ...
    a: 'Klasifikasi regulasi bervariasi tergantung pada produk dan yurisdiksi. Selalu tinjau informasi produk, Certificate of Analysis (COA), dan Disclaimer yang berlaku sebelum membeli. Jika Anda memerlukan informasi tentang status regulasi produk tertentu, silakan hubungi tim kami.',
  },
  {
